...
BOOL ORCHIDPATHS_CALLMETHOD COrchidPaths::GetModulePathA(const char* szArr, int nSize)
{
...
BOOL ORCHIDPATHS_CALLMETHOD COrchidPaths::GetModulePathW(const wchar_t* wszArr, int nSize)
{
	char chArr[MAX_PATH] = { 0 };
	char* pTemp = NULL;
	int nArrSize = 0;
